...
All code must follow this package layout (from `.claude/CLAUDE.md`):
...
## Step 5: Entity Design Rules (from `.omc/skills/domain-modeling.md`)
...
## Step 6: Test Conventions (from `.omc/skills/tdd-patterns.md`)
...
## Step 7: Controller and Layer Rules (from `.omc/skills/layer-architecture.md`)
